...
podTemplate(label: podLabel, cloud: cloud, serviceAccount: serviceAccount, envVars: [
    ...
    containers: [
        containerTemplate(name: 'nodejs', image: 'fabiogomezdiaz/nodejs:6-alpine', ttyEnabled: true, command: 'cat'),
        containerTemplate(name: 'docker' , image: 'fabiogomezdiaz/docker:18.09-dind', ttyEnabled: true, command: 'cat'),
